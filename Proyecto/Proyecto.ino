...
if (!SD.begin(chipSelect)) {
 ...
 myFile.close();
 myFile = SD.open("scores.txt", FILE_WRITE);
 myFile.println("325, 850, 890, 720, 350");
 myFile.close();
...
if (scene1 == 1){
 ...
 scene1++;
  ...
  myFile = SD.open("scores.txt", FILE_WRITE);
  if(variable > 99){
    dato0 = String(int(variable));}
  else{
    dato0 = "0" + String(int(variable));
  }

  if(data[4] > 99){
    dato1 = String(int(data[4]));}
  else {
    dato1 = "0" + String(int(data[4]));
  }
  if(data[3] > 99){
    dato2 = String(int(data[3]));}
  else {
    dato2 = "0" + String(int(data[4]));
  }

 if(data[2] > 99){
    dato3 = String(int(data[2]));}
  else {
    dato3 = "0" + String(int(data[2]));
  }

  if(data[1] > 99){
    dato4 = String(int(data[1]));}
  else {
    dato4 = "0" + String(int(data[1]));
  }
    
    String guardar = dato0 + "," + dato1 + "," + dato1 + "," + dato3 + "," + dato4; 
    myFile.println(guardar);
    myFile.close();
...
LCD_Clear(0x3838);
 LCD_Print("Press to restart",25, 220, 2, 0xFFFF, 0x3838); 
myFile = SD.open("scores.txt");
LoadSD(myFile, data);
...
String dato5 = String(int(data[0]));
 LCD_Print("5 latest scores", 15, 15, 2, 0xFFFF, 0x3838);
...
for (int i_2 = 0; i_2<31; i_2++){
 ...
 int y_2;
   ...
   if (scene3 == 2){
    ...
    else if (x_inicial2 == 177 & y_inicial2 >= 169){
        x_inicial2 = 177;
        x_2 = 177;
        y_inicial2 = 169;
      }
    ...
    if (x_inicial2>= 284){
    ...
    else if (x_2 >= 180 & x_2<= 240 & y_inicial2 == 169){
        y_inicial2 = 150;
        x_inicial2 =160;
        initialscore3 = initialscore3 - 20;
  ...
  else if (x_inicial2 >= 204 & y_inicial2 >= 169){
        x_inicial2 = 204;
        x_2 = 204;
        y_inicial2 = 169;
     ...
     else if (x_inicial2 >= 237 & y_inicial2 >= 150){
        x_inicial2 = 237;
        y_inicial2 = 150;
    ...
    int animation2_2 = (x_inicial2/10) % 20;// El módulo debe ser igual a la cantidad de columnas de su sprite. El 
    LCD_Sprite(x_inicial2, y_inicial2, 36, 36, kirby_caminar, 20, animation2_2, 0, 0);
    V_line(x_inicial2, y_inicial2, 36, 0x06DF);
 ...
 int y_1;
   ...
   if (scene2 == 2){
    ...
    else if (x_inicial1 == 17 & y_inicial1 >= 169){
        x_inicial1 = 17;
        x_1 = 17;
        y_inicial1 = 169;
      }
    ...
    if (x_inicial1>= 124){
  ...
  else if (x_inicial1 >= 44 & y_inicial1 >= 169){
        x_inicial1 = 44;
        x_1 = 44;
        y_inicial1 = 169;
     ...
     else if (x_inicial1 >= 77 & y_inicial1 >= 150){
        x_inicial1 = 77;
        y_inicial1 = 150;
    ...
    int animation2 = (x_inicial1/10) % 20;// El módulo debe ser igual a la cantidad de columnas de su sprite. El 
    LCD_Sprite(x_inicial1, y_inicial1, 36, 36, kirby_caminar, 20, animation2, 0, 0);
    V_line(x_inicial1, y_inicial1, 36, 0x06DF);
...
//Quieto
   ...
   int x_1 = 0;
    ...
    x_1 = x_inicial1;
    if (scene2 == 2){
       if (x_1 >= 0 & x_1 <= 17 & y_inicial1 >= 169){
        y_inicial1 = 169;
      ...
      else if (x_1 >= 18 & x_1 <= 160 & y_inicial1 >= 150){
...
/*Kirby2******************************************************************/
   ...
   int x_2 = 0;
    ...
    if (scene3 == 4){
       if (x_2 >= 160 & x_2 <= 179 & y_inicial2 >= 150){
      ...
      else if (x_2 >= 180 & x_2 <= 251 & y_inicial2 > 169){
        ...
        else if (x_2 >= 180 & x_2 <= 230 & y_inicial2 == 169){
        x_inicial2 = 160;
        y_inicial2 = 150;
        initialscore3 = initialscore3 - 50;
        FillRect(180, 172, 90, 36, 0x06DF); 
        LCD_Sprite(x_inicial2, y_inicial2, 36, 36, kirby_quieto, 8, animation3_2, 0, 0);
        H_line(x_inicial2 - 1, y_inicial2 + 36, 36, 0x06DF);
        if(animation3_2<9){
        animation3_2++;
